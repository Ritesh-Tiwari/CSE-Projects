<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Installment.aspx.cs" Inherits="Fess" %>
   ...
   <div class="Background">
        <div class="Menu">
            ...
            NavigateUrl="~/Admin.aspx">Admin</asp:HyperLink>
                  <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/Installment.aspx" ForeColor="red">Installmet</asp:HyperLink>
        ...
        <div class="form">
            ...
            <asp:Label ID="Label3" runat="server" Text="Installment"></asp:Label>
            <br /><br /><br />
            <asp:Label ID="Labe4" runat="server" Text="GST"></asp:Label>
            <br /><br /><br />
            <asp:Label ID="Labe5" runat="server" Text="Electric"></asp:Label>
              <br /><br /><br />
            <asp:Label ID="Label6" runat="server" Text="Paid date"></asp:Label>
            <br /><br /><br />
        ...
        <asp:TextBox ID="TextBox1" runat="server" ></asp:TextBox>
            ...
            <asp:Button ID="Button1" runat="server" onclick="Button3_Click1" 
                Text="Calculate" />
               <br />
            <br /><br /><br />
