<%-- 
    Document   : Driver
    Created on : Jun 24, 2019, 11:06:09 AM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>Driver Infromation</title>
        ...
        <form method="post" action="Driver.jsp">
         <div class="Menu">
            ...
            <ul>
                ...
                <li><a href="Driver.jsp" style="color:red;">DRIVER INFO</a></li>
        ...
        <div class="btn">
            ...
            <div class=" filed">
                ...
                <br/>  <textarea placeholder="Enter phone No" name="ph"></textarea>
                 <br/>    <label>customer License</label>
                 <br/>   <textarea placeholder="license" name="license"></textarea>
                  <br/>   <label>Customer Aadhar No</label>
                  <br/>   <textarea placeholder="Enter Aadhar No" name="aadh"></textarea>
                  <br/>   <label>Age</label>
                  <br/>   <textarea placeholder="Enter Aadhar No" name="age"></textarea><br/>
                  <input type="Submit" value="Submit" id="submit">
                  <script>
                      if(a==1)
                      {
                          alert("Reccord Inserted");
                      }
                  </script>
            </div>
        </form>
